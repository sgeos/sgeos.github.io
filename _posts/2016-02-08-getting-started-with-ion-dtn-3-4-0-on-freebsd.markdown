...
After serving basic web content with [tor][freebsd-tor], I wanted to try to serve a web page over DTN.
...
The goal was to was to take an outside web request, send it over DTN to a ser on the other side and return the response.
