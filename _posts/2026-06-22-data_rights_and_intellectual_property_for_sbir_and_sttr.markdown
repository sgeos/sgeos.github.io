...
The [Phase III article][related_post_phase_three] said that the sole-source
...
non-dilutive not only in equity but in [intellectual property][ref_ip], and the
...
[current policy directive][research_sbir_gov] and the acquisition regulations are
the authority.

## Two Bodies of Rights

Intellectual property in these programs divides into two bodies of law that are
easy to conflate and important to separate.
The first is patent rights, which concern who owns an invention made under the
award, governed by the [Bayh-Dole Act][ref_bayh_dole] and its framework for
...
A company can own a [patent][ref_patent] on its invention and still mishandle the
...
partner relationship the [eligibility article][related_post_eligibility]
introduced.

## Patent Rights Under Bayh-Dole

For inventions, the law is generous to the company.
...
that travels with the retained title.

## SBIR Data Rights

For technical data and software, the program provides a special and unusually
strong protection.
The government receives a [license][ref_software_license] to use the SBIR and
...
## Marking Is the Act That Preserves the Rights

The single most consequential practical point in this article is that data rights
...
[proposal article][related_post_phase_one] urged for the proprietary markings on
the proposal itself.
...
records that show what it paid for.

## The Categories of Rights

The acquisition regulations sort data and software into categories that decide
...
The [SBIR data rights][ref_far] are a distinct and protected category created by
the program, stronger than government-purpose rights during the protection
period, and the [defense data-rights clauses][ref_dfars] elaborate all of this in
the [contracts][research_dod] where the rights are most often contested.
...
The balance the program strikes is worth stating plainly.
...
[copyright][ref_copyright] and the [trade secrets][ref_trade_secret], and above
...
souring the relationship or under-claiming and losing the asset.

## Threats to the Crown Jewel

The rights are lost in a handful of recognizable ways, and each is avoidable.
...
Software that incorporates [open-source][ref_open_source] or other third-party
...
defense against all of them is to treat the rights as the core asset they are.

## How the Rights Create Value

The data rights are not merely defensive, since they are what make the company
worth something.
...
The [non-dilutive funding][related_post_intro] built a technology, and the
retained rights are what turn that technology into property, which is the whole
point of keeping them.

## Scale and the UAV Case

The running example shows the stakes concretely.
The small company's autopilot software and its [airframe][related_post_prototyping]
...
company built on funded research they are.
...
Data rights and intellectual property are the crown jewel of an SBIR or STTR
...
most valuable thing it owns, which they are.

## References

- [Reference, Bayh-Dole Act][ref_bayh_dole]
- [Reference, Copyright][ref_copyright]
- [Reference, Defense Federal Acquisition Regulation Supplement][ref_dfars]
- [Reference, Federal Acquisition Regulation][ref_far]
- [Reference, Intellectual Property][ref_ip]
- [Reference, Open-Source Software][ref_open_source]
- [Reference, Patent][ref_patent]
- [Reference, Software License][ref_software_license]
...
- [Research, SBIR and STTR (the official program portal and policy directive)][research_sbir_gov]
...
[ref_copyright]: https://en.wikipedia.org/wiki/Copyright
[ref_dfars]: https://en.wikipedia.org/wiki/Defense_Federal_Acquisition_Regulation_Supplement
[ref_far]: https://en.wikipedia.org/wiki/Federal_Acquisition_Regulation
[ref_ip]: https://en.wikipedia.org/wiki/Intellectual_property
[ref_open_source]: https://en.wikipedia.org/wiki/Open-source_software
