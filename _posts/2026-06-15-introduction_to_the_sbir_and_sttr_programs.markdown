...
The previous series designed and equipped a fixed-wing unmanned aircraft from
...
[regulatory article][related_post_regulatory] of the last series, that these are
...
The programs are also not permanent, as the next section shows.

## A Program That Runs on Reauthorization

The [Small Business Innovation Research][ref_sbir] program, usually called SBIR,
was created in 1982, and the [Small Business Technology Transfer][ref_sttr]
...
[Congressional Research Service][research_crs] surveys.
...
tomorrow.
The [Small Business Administration][ref_sba] oversees both programs and issues
...
rules is the [common entry point][research_sbir_gov] for an applicant.

## The Core Idea, Non-Dilutive and Mission-Pulled

The defining feature of the programs is that the money is non-dilutive.
Unlike the [venture capital][ref_venture_capital] or the
[seed money][ref_seed_money] a startup might raise, an award takes no equity and
imposes no [dilution][ref_dilution] on the founders, so a company can fund real
[research and development][ref_rnd] while keeping its ownership and, as a later
...
[mission-critical engineering][related_post_engineering] an agency cannot buy
...
program, [America's Seed Fund][research_seedfund].
...
resubmit, a discipline a later article treats.

## The Three Phases

The staircase has three steps.
...
recompeting it.
Read against the [technology readiness level][ref_trl] scale the defense and
...
transition is a multi-year undertaking rather than a single season's work.

## SBIR Versus STTR

The two programs are siblings with one decisive difference.
...
[federally funded research and development center][ref_ffrdc], and the rules set
...
already or inside a research institution it must partner with.

## Who Can Compete

Eligibility is narrow by design, since the programs exist to fund small
...
Non-dilutive capital that funds real research is rare, and that is the program's
value.
...
[Bayh-Dole Act][ref_bayh_dole] and the program's own data-rights regime.
...
for a company whose product is genuinely an innovation an agency wants.

## What the Programs Are Not

Several misunderstandings are worth dispelling at the outset.
The award comes in one of two forms depending on the agency, a
[grant][ref_grant] or cooperative agreement at the agencies that fund research
that way, or a procurement [contract][ref_procurement] at the agencies that buy
...
early development rather than a business model in itself.

## The Series Ahead

This article is the orientation, and the rest of the series follows the
...
[fixed-wing unmanned aircraft][related_post_prototyping] of the previous series
from a Phase I feasibility study through a Phase II prototype to a Phase III
transition, tying the engineering and the funding together.

## Out of Scope

A few things are deliberately set aside here.
...
counsel on a particular company's situation.
...
- [Reference, Research and Development][ref_rnd]
- [Reference, Seed Money][ref_seed_money]
- [Reference, Small Business Administration][ref_sba]
- [Reference, Small Business Innovation Research][ref_sbir]
- [Reference, Small Business Technology Transfer][ref_sttr]
...
- [Related Post, The Regulatory and Operations Layer for Fixed-Wing UAVs][related_post_regulatory]
- [Research, America's Seed Fund (National Science Foundation)][research_seedfund]
