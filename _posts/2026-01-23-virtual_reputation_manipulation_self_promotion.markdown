...
with $T(\mathbf{x})$ the test statistic evaluated on the observed data $\mathbf{x}$. Detection triggers when $\lvert z_{\text{anomaly}} \rvert$ exceeds a chosen threshold, typically calibrated to a desired false-positive rate. The [Kumar et al 2017][research_kumar_et_al_2017] rating-distribution treatment and the [Xie et al 2012][research_xie_et_al_2012] temporal-pattern treatment establish the reference methodology.
