...
their applicability
to
significant distributed protocols.
Gradual typing,
which
...
also
produced
marked new statically typed programming languages
that
combined
existing techniques
into
...
a form
that
carried sizable ergonomic engineering
alongside
...
the borrow checker,
and
an appreciable standard library
into
...
to
produce
significant industrial verified code,
including
...
the following decade
in
sizable industrial verification work
including
...
The twenty tens
saw
appreciable industrial application
of
multiparty session types.
...
executable code
in
considerable mainstream languages
including
Java,
Python,
Go,
...
gradual typing
to
an extensive industrial Ruby codebase
and
demonstrated
that
gradual typing
...
Elixir
provided
a greatly more approachable surface syntax
than
Erlang
along with
