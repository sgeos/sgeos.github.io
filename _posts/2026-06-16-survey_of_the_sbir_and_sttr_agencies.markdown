...
The [orientation article][related_post_intro] said that the Small Business
...
[grant][ref_grant] or cooperative agreement or buys it as a procurement
[contract][ref_procurement], which decides the obligations, the accounting, and
the relationship.
...
solicitation, found through the [official program portal][research_sbir_gov], is
the authority.

## The Two Axes and Where the Agencies Sit

The two axes are independent, and the agencies populate the corners.
...
understands the corner an agency sits in writes a proposal that fits it.

## How Many Agencies, and Why the Sizes Differ

Eleven agencies run SBIR and five of them also run STTR, the five being the
...
The map that follows treats the five largest in turn and then groups the rest.

## The Department of Defense

The [Department of Defense][ref_dod] runs the largest program, and it is the
...
[AFWERX][ref_afwerx] arm, the [Defense Advanced Research Projects Agency][ref_darpa],
the Missile Defense Agency, and others each running their own topics through the
common [Defense SBIR and STTR Innovation Portal][research_dod].
...
[unmanned aircraft][related_post_prototyping] of the previous series, the kind of
[mission-critical engineering][related_post_engineering] a defense customer buys.
...
defense and mission agencies.

## The National Institutes of Health

The [National Institutes of Health][ref_nih], part of the Department of Health
...
priorities, and its dedicated [small-business office][research_nih] is the entry
point an applicant learns to navigate.

## The National Science Foundation

The [National Science Foundation][ref_nsf] funds research on grants across a
broad range of deep-technology areas, and it brands its program
[America's Seed Fund][research_nsf].
...
mission, the foundation is often the natural first door.

## The Department of Energy

The [Department of Energy][ref_doe] sits in the mixed corner, funding directed
...
[topic releases][research_doe].

## NASA

[NASA][ref_nasa] is a mission agency like the Department of Defense, buying
...
It runs an [annual solicitation][research_nasa], and for a technology aimed at
space, aeronautics, or the instrumentation they need, it is the obvious door.

## The Smaller Agencies

The remaining agencies run real but smaller programs, each shaped by its mission,
and none of them runs STTR.
The [Department of Agriculture][ref_usda] funds agriculture, food, forestry, and
rural innovation on grants.
The [Department of Homeland Security][ref_dhs] buys homeland-security technology
on contract against directed topics, much like a mission agency.
The Department of Commerce runs two, the
[National Oceanic and Atmospheric Administration][ref_noaa] for oceans, weather,
and climate, and the [National Institute of Standards and Technology][ref_nist]
for measurement and standards.
The [Department of Education][ref_ed] funds education technology, the
[Department of Transportation][ref_dot] funds transportation innovation, and the
[Environmental Protection Agency][ref_epa] funds environmental technology.
Each is a smaller pond, which can mean less competition for a tightly matched
technology, and each follows its own vehicle, topics, and cadence.

## The Agencies at a Glance

The table summarizes the major agencies on the two axes and a few practical
points, with the smaller agencies grouped on the last row.
...
The Direct to Phase II and relative-size entries are themselves current-as-of,
since the paths a given agency offers and the budget it commands change with each
year and each reauthorization.

## Choosing Where to Apply

The survey resolves into a practitioner's decision.
...
this article is the guide to choosing which house to knock on.

## Out of Scope

Several things are deliberately left aside.
...
The SBIR and STTR programs are a single program run in eleven houses, and the
...
choice into an award.

## References

- [Reference, AFWERX][ref_afwerx]
- [Reference, Defense Advanced Research Projects Agency][ref_darpa]
- [Reference, Federal Grants in the United States][ref_grant]
- [Reference, Government Procurement in the United States][ref_procurement]
- [Reference, NASA][ref_nasa]
- [Reference, National Institute of Standards and Technology][ref_nist]
- [Reference, National Institutes of Health][ref_nih]
- [Reference, National Oceanic and Atmospheric Administration][ref_noaa]
- [Reference, National Science Foundation][ref_nsf]
- [Reference, United States Department of Agriculture][ref_usda]
- [Reference, United States Department of Defense][ref_dod]
- [Reference, United States Department of Education][ref_ed]
- [Reference, United States Department of Energy][ref_doe]
- [Reference, United States Department of Homeland Security][ref_dhs]
- [Reference, United States Department of Transportation][ref_dot]
...
- [Related Post, Fast-Moving Versus Mission-Critical Engineering][related_post_engineering]
- [Related Post, Prototyping Fixed-Wing Aircraft with Lightweight PLA and Fiberglass][related_post_prototyping]
- [Research, DoD SBIR and STTR (Defense SBIR/STTR Innovation Portal)][research_dod]
- [Research, NASA SBIR and STTR][research_nasa]
- [Research, NIH SEED, the Small Business Education and Entrepreneurial Development Office][research_nih]
- [Research, SBIR and STTR (the official program portal)][research_sbir_gov]
- [Research, SBIR and STTR at the Department of Energy][research_doe]
