...
with $R_v$ the specific gas constant of water vapor and $V$ the room volume, and the resulting relative humidity is the ratio of the vapor pressure to the saturation pressure
...
The weighting question asks whether the dimension weights of the immersion facility are stable across bathing cultures or vary with the meanings each culture attaches to communal bathing, nudity, and the body. The historical evidence records substantial variation, but the specific weighting functions are not resolved.
