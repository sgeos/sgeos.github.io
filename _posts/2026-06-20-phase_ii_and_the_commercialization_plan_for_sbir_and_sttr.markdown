...
The [previous article][related_post_phase_one] wrote a Phase I proposal whose
...
current-as-of and the [live solicitation][research_sbir_gov] and the policy
directive are the authority.

## What Phase II Builds

Phase II is the development award, and its character follows from that.
...
protection the data-rights article treats.

## The Gate from Phase I

Phase II is not open to everyone, since it is normally the second step of a
sequence.
...
between winning and starting that a company should expect.

## The Phase II Proposal

The Phase II proposal resembles the Phase I proposal in shape but shifts in
emphasis.
...
work-split limit the [eligibility article][related_post_eligibility] set binds
...
the Phase I overpromise.

## The Commercialization Plan as a Deliverable

The commercialization plan is the heart of Phase II, and it is a
[business plan][ref_business_plan] for the technology.
It states the market and sizes it through a credible
[market analysis][ref_market_analysis], it names the customer and states the
[value proposition][ref_value_proposition], the reason that customer would buy,
and it confronts the competition honestly rather than claiming to have none.
It describes the business model and the
[go-to-market strategy][ref_gtm] that carries the prototype to revenue, the
...
[memorandum of understanding][ref_mou] from a real customer or transition
...
[eligibility article][related_post_eligibility] described, so a Phase II
...
compliance article treats.

## Transition Versus Market Commercialization

The commercialization plan comes in two flavors, set by the agency culture the
[survey][related_post_agencies] described.
At a [mission agency][research_dod] the goal is transition, the carrying of the
...
[technology transfer][ref_technology_transfer] from the project to a program of
record.
At a [science agency][research_nsf] the goal is market commercialization, the
carrying of the
...
A [dual-use][ref_dual_use] technology can pursue both, a government transition
...
## Extending Phase II and Bridging Toward Phase III

The program provides mechanisms to extend a Phase II toward commercialization,
...
[commercialization readiness program][research_nih] that funds the late-stage
work of preparing a result for transition or market, the [commercialization][ref_commercialization]
...
Phase II sharpens the cash-flow problem that runs through the whole program.
...
The characteristic Phase II failures are about the business as much as the
technology.
...
without building the case that someone will buy it.

## Scale and the UAV Case

The running example reaches its development phase.
The small company that proved in Phase I that its
[unmanned aircraft][related_post_prototyping] could meet a capability now wins a
...
the award as the financing of a young business rather than a grant to spend.
...
Phase II is the step where the program stops asking whether an idea can work and
...
plan, which points directly at Phase III, the subject of the next article.

## References

- [Reference, Business Plan][ref_business_plan]
- [Reference, Commercialization][ref_commercialization]
- [Reference, Dual-Use Technology][ref_dual_use]
- [Reference, Go-to-Market Strategy][ref_gtm]
- [Reference, Market Analysis][ref_market_analysis]
- [Reference, Memorandum of Understanding][ref_mou]
- [Reference, Product-Market Fit][ref_pmf]
- [Reference, Prototype][ref_prototype]
- [Reference, Technology Readiness Level][ref_trl]
- [Reference, Technology Transfer][ref_technology_transfer]
- [Reference, Value Proposition][ref_value_proposition]
- [Related Post, A Survey of the SBIR and STTR Agencies][related_post_agencies]
...
[ref_business_plan]: https://en.wikipedia.org/wiki/Business_plan
...
[ref_gtm]: https://en.wikipedia.org/wiki/Go-to-market_strategy
[ref_market_analysis]: https://en.wikipedia.org/wiki/Market_analysis
[ref_mou]: https://en.wikipedia.org/wiki/Memorandum_of_understanding
[ref_pmf]: https://en.wikipedia.org/wiki/Product-market_fit
[ref_prototype]: https://en.wikipedia.org/wiki/Prototype
...
[ref_value_proposition]: https://en.wikipedia.org/wiki/Value_proposition
