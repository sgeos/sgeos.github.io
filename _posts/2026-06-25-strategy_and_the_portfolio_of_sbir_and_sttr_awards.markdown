...
The series so far has followed a single award from the decision to pursue it
...
against the [risk reduction][ref_trl] the whole series has tracked, to build a
...
the [official program portal][research_sbir_gov] and the
[Small Business Administration][ref_sba] that coordinates the programs are the
authority.

## The Award Is a Means

The award funds the reduction of technical risk, and that is all it funds.
The grant or contract pays a company to take a technology from one
[readiness level][ref_trl] to a higher one, and the company that mistakes the
...
## Transition Versus the Mill

The central strategic choice is what role the awards play in the company.
A company pursuing transition uses the awards to cross the
[valley of death][related_post_valley_of_death] into a product, a program of
...
exist, and it builds a [commercialization][ref_commercialization] record that the
...
A company that wins more than one award holds a portfolio, and a portfolio can be
managed well or badly.
The same logic that governs any [diversified][ref_diversification] holding applies,
...
The federal awards are not the only non-dilutive capital available, and a strategic
company stacks them.
Many states run their own programs that supply [matching funds][ref_matching_funds]
to companies that win a federal award, multiplying the federal dollar with a state
one that costs the company no equity, and the [Small Business Administration][ref_sba]
...
programs in the [official directory][research_sbir_gov] and at the
[administering agency][research_sba] as deliberately as it learns the federal
solicitations.

## The Private-Capital Bridge

At some point a transition-minded company needs more capital than the awards
supply, and that capital is usually private and dilutive.
[Venture capital][ref_venture_capital], an [angel investor][ref_angel], or a
[seed][ref_seed] round brings money the awards cannot, but it brings it in exchange
for ownership, the [equity dilution][ref_dilution] that non-dilutive awards avoid,
...
There is a structural wrinkle the [eligibility article][related_post_eligibility]
...
The bridge across the [valley of death][related_post_valley_of_death] is usually
...
buys the most it can.

## The Market Beyond the Government

A company that transitions only into a single government program is still
concentrated, and the broadest strategy reaches a market beyond it.
A [dual-use][ref_dual_use] technology, one that serves a commercial market as well
as a government mission, gives the company a second leg to stand on, so that a
[commercialization][ref_commercialization] into private revenue protects it from
the shifts in any single agency's budget.
Some agencies are organized around exactly this outcome, the National Science
Foundation running its [seed fund][research_nsf] for technologies headed to a
...
commercialization story in the proposal and a more durable company after the award.

## Choosing What to Pursue

Strategy is as much about what a company declines as about what it pursues.
Every proposal costs scarce engineering and writing time, so the
[opportunity cost][ref_opportunity_cost] of chasing a poorly fitting topic is the
...
The running example shows the portfolio in miniature.
The small company building its [unmanned aircraft][related_post_prototyping] does
...
runway.
It uses the de-risked prototype from its [Phase II][related_post_commercialization]
...
[money][related_post_money] from all of these sources as one coordinated stack
...
and not to let winning awards become the company.
...
read from the current authorities.

## Conclusion

The strategy of the programs is to treat the award as a means and not an end, to
...
- [Reference, Angel Investor][ref_angel]
- [Reference, Commercialization][ref_commercialization]
- [Reference, Diversification (Finance)][ref_diversification]
- [Reference, Dual-Use Technology][ref_dual_use]
- [Reference, Matching Funds][ref_matching_funds]
- [Reference, Opportunity Cost][ref_opportunity_cost]
- [Reference, Seed Money][ref_seed]
- [Reference, Small Business Administration][ref_sba]
- [Reference, Stock Dilution][ref_dilution]
- [Reference, Technology Readiness Level][ref_trl]
- [Reference, Venture Capital][ref_venture_capital]
- [Related Post, Eligibility and the Registration Stack for SBIR and STTR][related_post_eligibility]
- [Related Post, Finding a Topic and Reading an SBIR or STTR Solicitation][related_post_topic]
- [Related Post, Phase II and the Commercialization Plan for SBIR and STTR][related_post_commercialization]
...
- [Research, America's Seed Fund (the National Science Foundation portal)][research_nsf]
- [Research, SBIR and STTR (the official program portal)][research_sbir_gov]
- [Research, U.S. Small Business Administration][research_sba]
