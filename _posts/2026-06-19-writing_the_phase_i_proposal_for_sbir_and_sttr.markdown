...
The [solicitation article][related_post_solicitation] ended with the company
...
[response to a request][ref_rfp] scored against a rubric, and the proposal that
...
## What Phase I Actually Asks

Phase I is a [feasibility study][ref_feasibility], and remembering that is the
...
[proof of concept][ref_poc] rather than a finished thing, and it carries the
technology from the lowest rungs of the
[technology readiness level][ref_trl] scale toward a demonstrated principle, a
rung of the staircase the [orientation article][related_post_intro] described.
...
to answer it in the months and dollars Phase I allows, and no more.

## The Volumes and Their Shape

A proposal is not one document but a set, and the set has a predictable shape.
...
[innovation portal][research_dod], the National Institutes of Health in its
[application guide][research_nih], the National Science Foundation in its
[proposal instructions][research_nsf], and all of them indexed from the
[program portal][research_sbir_gov], so the writer builds the proposal to the
...
The technical volume follows a standard arc whatever the agency.
...
so the arc is not a formality but the order of the questions the reviewer asks.

## The Three Things a Reviewer Scores

Behind the sections are the criteria, and the criteria are usually three.
...
criterion is points simply forfeited.

## Writing the Innovation

The heart of the technical volume is the innovation, and it must be made
unmistakable.
...
And it does all this in plain [technical writing][ref_technical_writing], without
the jargon that hides a thin idea, because the reviewer may be a generalist and
because clarity reads as competence while obscurity reads as confusion.

## The Work Plan

The work plan turns the innovation into a believable project.
It breaks the effort into tasks, a [work breakdown][ref_wbs] a reviewer can
follow, each task tied to a technical objective and to a deliverable, with
[milestones][ref_milestone] that mark progress and a clear statement of what
finishing Phase I will have shown.
It addresses the technical risk honestly through a
[risk management][ref_risk] plan, naming what could go wrong and how the plan
...
the feasibility result leads somewhere.

## The Team and the Past Performance

A good idea with no one credible to execute it does not win.
The proposal presents the principal investigator, who must meet the employment
rule the [eligibility article][related_post_eligibility] gave, and the key
...
strength of the individuals and the clarity of the plan.

## The Commercialization Story

Even in Phase I, the proposal must say who will buy the result and why.
...
[commercialization][ref_commercialization] model that gets it there.
A [dual-use][ref_dual_use] technology that serves both a government mission and a
...
and a paragraph of optimism.

## Writing to the Reviewer

The proposal is read by a person under time pressure, and writing for that person
is its own skill.
At a science agency the reviewer is part of a [peer-review][ref_peer_review]
...
[red-team][ref_red_team] review proposal shops rely on, catches the gaps and the
unclear passages the author has gone blind to, and the time to find them is
before the agency does.

## Review, Debrief, and Resubmission

What happens after submission is part of the craft too.
...
Beyond the compliance failures the solicitation article warned of, a handful of
...
argument scored against a rubric and writes accordingly.

## Scale and the UAV Case

The running example shows a Phase I in miniature.
The small company holding a technology like the
[unmanned aircraft][related_post_prototyping] of the engineering series, having
...
debrief and resubmits a sharper version next cycle.

## Out of Scope

Several matters belong to other articles.
...
this overview, and nothing here is legal advice on a particular proposal's terms.

## Conclusion

A Phase I proposal is an argument that the company can retire an idea's
...
- [Reference, Commercialization][ref_commercialization]
- [Reference, Dual-Use Technology][ref_dual_use]
- [Reference, Feasibility Study][ref_feasibility]
- [Reference, Milestone in Project Management][ref_milestone]
- [Reference, Peer Review][ref_peer_review]
- [Reference, Proof of Concept][ref_poc]
- [Reference, Red Team][ref_red_team]
- [Reference, Request for Proposal][ref_rfp]
- [Reference, Risk Management][ref_risk]
- [Reference, Technical Writing][ref_technical_writing]
- [Reference, Technology Readiness Level][ref_trl]
- [Reference, Work Breakdown Structure][ref_wbs]
- [Related Post, An Introduction to the SBIR and STTR Programs][related_post_intro]
- [Related Post, Finding a Topic and Reading an SBIR or STTR Solicitation][related_post_solicitation]
- [Related Post, Prototyping Fixed-Wing Aircraft with Lightweight PLA and Fiberglass][related_post_prototyping]
- [Related Post, SBIR and STTR Eligibility and the Registration Stack][related_post_eligibility]
...
[ref_feasibility]: https://en.wikipedia.org/wiki/Feasibility_study
[ref_milestone]: https://en.wikipedia.org/wiki/Milestone_(project_management)
[ref_peer_review]: https://en.wikipedia.org/wiki/Peer_review
[ref_poc]: https://en.wikipedia.org/wiki/Proof_of_concept
[ref_red_team]: https://en.wikipedia.org/wiki/Red_team
[ref_rfp]: https://en.wikipedia.org/wiki/Request_for_proposal
[ref_risk]: https://en.wikipedia.org/wiki/Risk_management
