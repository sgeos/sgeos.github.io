...
The series has been a United States playbook, the programs, the agencies, the
...
[valley-of-death article][related_post_valley_of_death] described, and each has
built some public instrument to fund the [risk reduction][ref_trl] that private
...
current-as-of and each country's own program authority is the only reliable source.

## The Common Problem

The reason every advanced economy intervenes is the same one the American program
rests on.
Early-stage high-risk technology is a [market failure][ref_market_failure], since
...
choice of how to supply it is a choice of [industrial policy][ref_industrial_policy]
that each country makes differently.
The American answer, the staged competitive award that the
[introductory article][related_post_introduction] laid out, is one design among
several, and seeing it beside the others shows which of its features are essential
to the problem and which are particular to the United States.

## The Procurement Copies

The closest analogs are the programs built deliberately on the American model, the
...
pattern for years and renamed it [Contracts for Innovation][research_innovate_uk] in
2024, a scheme in which [Innovate UK][ref_innovate_uk] and a public body pose a
...
runs [Innovative Solutions Canada][research_isc], whose challenge stream awards a
...
[New Energy and Industrial Technology Development Organization][ref_nedo], so the
...
[Horizon Europe][ref_horizon] framework, the umbrella under which most Union science
money flows, and within it the [European Innovation Council][ref_eic] runs the
instrument closest to the American program for small firms, the
[Accelerator][research_eic], which funds high-risk high-impact innovation by single
companies.
Alongside the Union's own programs the intergovernmental [Eureka][ref_eureka]
...
The series pairs SBIR with STTR, and the two differ in one feature, that the
[eligibility rules][related_post_eligibility] require an STTR award to be carried out
...
States and Canada both in fact run versions of each.
...
opposite pole from the American program, which the [money article][related_post_money]
...
the technologies it funds.

## Defense and Dual-Use

Defense ministries fund innovation through their own analogs, and the newest of note
is multinational.
The North Atlantic Treaty Organization established the
[Defence Innovation Accelerator for the North Atlantic][ref_diana] to develop
...
the American defense agencies follow.

## The Axes of Difference

Laid side by side the analogs map onto a small set of design choices.
...
or open, and whether the award is staged in phases or paid in one shot.
...
These choices are not mutually exclusive, since most countries run more than one
...
ownership, and the [portfolio strategy][related_post_strategy] the previous article
...
credit much as an American firm stacks its federal award and its state match.

## Scale and the UAV Case

The running example would find a path under most of these regimes.
The small company building its [unmanned aircraft][related_post_prototyping] could
...
same climb in every country.

## Out of Scope

Several matters belong elsewhere or to specialists.
...
program, and the worked capstone that follows returns to the United States.

## Conclusion

Every advanced economy faces the same market failure in early-stage high-risk
...
that staircase in full.

## References

- [Reference, Defence Innovation Accelerator for the North Atlantic][ref_diana]
- [Reference, European Innovation Council][ref_eic]
- [Reference, Eureka (Organisation)][ref_eureka]
- [Reference, Horizon Europe][ref_horizon]
- [Reference, Industrial Policy][ref_industrial_policy]
- [Reference, Innovate UK][ref_innovate_uk]
- [Reference, Israel Innovation Authority][ref_iia]
- [Reference, Market Failure][ref_market_failure]
- [Reference, New Energy and Industrial Technology Development Organization][ref_nedo]
- [Reference, Scientific Research and Experimental Development Tax Credit Program][ref_sred]
- [Reference, Technology Readiness Level][ref_trl]
- [Related Post, Eligibility and the Registration Stack for SBIR and STTR][related_post_eligibility]
- [Related Post, Introduction to the SBIR and STTR Programs][related_post_introduction]
- [Related Post, Phase III and the Valley of Death for SBIR and STTR][related_post_valley_of_death]
- [Related Post, Prototyping Fixed-Wing Aircraft with Lightweight PLA and Fiberglass][related_post_prototyping]
- [Related Post, Strategy and the Portfolio of SBIR and STTR Awards][related_post_strategy]
- [Related Post, The Money Behind an SBIR or STTR Award][related_post_money]
- [Research, EIC Accelerator (the European Innovation Council portal)][research_eic]
- [Research, Innovate UK Contracts for Innovation (the UK Research and Innovation portal)][research_innovate_uk]
- [Research, Innovative Solutions Canada (the Canadian program portal)][research_isc]

[ref_diana]: https://en.wikipedia.org/wiki/Defence_Innovation_Accelerator_for_the_North_Atlantic
