...
The series has built its argument one piece at a time, the programs, the agencies,
...
## The Company and the Airframe

The company is the small firm that has run through the whole series, the one
building a [fixed-wing unmanned aircraft][related_post_prototyping] from lightweight
printed structures and fiberglass.
Its technology is an [unmanned aerial vehicle][ref_uav] airframe with an unusual
endurance-to-cost ratio, and it is deliberately a [dual-use][ref_dual_use] design,
...
contract and little capital, the exact position the programs exist to address.

## Deciding to Pursue

The company begins where the [introductory article][related_post_introduction] began,
...
government wants, so it reads the [survey of the agencies][related_post_agencies] to
...
[defense innovation portal][research_dod], with the broader
[program portal][research_sbir_gov] showing the civilian agencies as a later
possibility.
...
Before it can compete the company must become eligible, the unglamorous groundwork
the [eligibility article][related_post_eligibility] laid out.
...
## Finding the Topic and Winning Phase I

With the groundwork done the company hunts for the right topic, the discipline the
...
The company wins, and the win is the first rung of the staircase.

## Phase II and the Prototype

Phase II is where the real engineering happens, the stage the
[commercialization-plan article][related_post_phase_two] covered.
...
technology reaches a [market][ref_commercialization] beyond the award, which for this
...
in mind would struggle to write the second half convincingly.

## The Money, the Rights, and the Compliance

Holding two awards in sequence forces the company to confront the matters the middle
of the series treated.
It builds the compliant accounting and the indirect rate the
[money article][related_post_money] described, learning that the rate decides how
...
[data rights][related_post_data_rights] the program grants, the cheap administrative
...
[after-the-award article][related_post_after_award] catalogued, reporting on
...
integrity rules it obeys are what keep it eligible at all.

## The Valley of Death and Phase III

Between a finished prototype and a production contract lies the gap the
[Phase III article][related_post_phase_three] called the valley of death, and crossing
...
top of the staircase reached.

## The Strategy Over Time

One campaign is not a company, which is the argument the
[strategy article][related_post_strategy] made.
...
[international analogs][related_post_international] to consider, a British or Canadian
...
The same campaign read in reverse is a catalog of the failures the series warned
against.
...
campaign succeeds precisely by avoiding them in the order the series presented them.

## Out of Scope

Several matters remain outside this capstone as they were outside the series.
...
legal, financial, accounting, or contracting advice for a particular campaign.

## Conclusion

The programs supply non-dilutive capital in stages against demonstrated risk
...
- [Reference, Unmanned Aerial Vehicle][ref_uav]
- [Related Post, A Survey of the SBIR and STTR Agencies][related_post_agencies]
- [Related Post, After the Award, Compliance and Reporting for SBIR and STTR][related_post_after_award]
- [Related Post, An Introduction to the SBIR and STTR Programs][related_post_introduction]
- [Related Post, Data Rights and Intellectual Property in SBIR and STTR][related_post_data_rights]
- [Related Post, Finding a Topic and Reading an SBIR or STTR Solicitation][related_post_topic]
- [Related Post, International Analogs to SBIR and STTR][related_post_international]
