...
The [Phase II article][related_post_phase_two] ended with a prototype and a
...
[live policy directive][research_sbir_gov] is the authority.

## What Phase III Is

Phase III is the commercialization of the work the earlier phases matured, and
...
On the [technology readiness level][ref_trl] scale the
[orientation article][related_post_intro] introduced, Phase III is the climb from
...
The single most valuable thing the program grants at Phase III is a procurement
authority.
...
[competition][ref_procurement] that federal buying normally requires.
...
the most common misreading of Phase III.

## The Valley of Death

Between the Phase II prototype and a sustained Phase III the ground falls away.
...
is about the two ways across, the government transition and the market.

## Crossing by Government Transition

For a technology aimed at a [government mission][research_dod], crossing means
transition into a program.
The company needs a [program of record][ref_program_of_record] or an operational
...
[acquisition][ref_acquisition] process as about the technology, and it favors a
requirement that pulls the technology in over a technology that pushes itself at
an uninterested customer.
Often the path runs through a [prime contractor][ref_prime] that integrates the
...
enhancement and the commercialization readiness [program][research_nih] that
bridge the gap with more funding, and arrangements such as a
[cooperative research and development agreement][ref_crada] with a laboratory or
a partnership with a prime, all resting on the
[technology transfer][ref_technology_transfer] from the small company into the
larger system, alongside the state programs, the commercialization assistance,
and the accelerators that the money and strategy articles describe.

## Crossing by the Market

For a technology aimed at a [commercial market][research_nsf], crossing means a
...
which is often where [venture capital][ref_venture_capital] or revenue takes over
...
must clear the [Food and Drug Administration][ref_fda] before it can be sold, and
that path is its own long valley with its own cost.
A [dual-use][ref_dual_use] technology can cross both ways at once, a government
...
[commercialization][ref_commercialization] into two markets is more robust than
dependence on one.

## Why Phase III Is the Point

Phase III is not an afterthought to the program but its entire purpose.
...
the [eligibility article][related_post_eligibility] described actually measure,
...
The valley claims companies in recognizable ways.
...
for the unfunded building of a business.

## Scale and the UAV Case

The running example reaches the edge of the valley.
The small company that built its [unmanned aircraft][related_post_prototyping]
...
Nothing in this article is legal, financial, or investment advice.

## Conclusion

Phase III is the destination the whole staircase pointed at, the commercialization
...
proposal rather than discovering it at the prototype's edge.

## References

- [Reference, Commercialization][ref_commercialization]
- [Reference, Cooperative Research and Development Agreement][ref_crada]
...
- [Reference, Military Acquisition][ref_acquisition]
- [Reference, Prime Contractor][ref_prime]
- [Reference, Program of Record][ref_program_of_record]
