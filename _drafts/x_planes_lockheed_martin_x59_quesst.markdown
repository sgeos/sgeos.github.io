...
| How loud it is to a person, which is a different question from how large it is | 490 |
| What a boom does to a building | 21 |
...
**8 of 10 conclusions measure thin under this article's own words and 10 of 10 are covered under the field's.** That is the fifth article running with that result, and the reason is the same. **A probe written in the author's phrasing measures the author.**
