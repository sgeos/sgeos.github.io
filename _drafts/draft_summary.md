...
### History of SpaceX Government-Anchor Capital-Formation Leg article (A289) — Drafted (both density passes complete)
...
**Completion**: Complete draft with full structural section set, reference apparatus, and equation-density expansion pass. Awaits human pilot review and publication authorization.
...
**Status**: Draft 2026-08-02, with equation-density and primary-reference expansion passes the same day. Equation pass added 44 display equations (26 to 70). Primary-reference pass added 30 primary reference URLs (91 to 121) at the claims a citation audit found uncited, principally the COTS round-one award amounts, the round-two re-competition, the Dragon and Commercial Crew flight record, the Boeing Starliner programme record, the launch-infrastructure arrangements, and the international liability framework. 1,102 lines, ~16,501 words, 70 display equations, 27 H2 sections, 11 H3 subsections, 50 book references, 121 primary reference URLs, 43 research references, 19 related-post cross-references, 233 total reference anchors with zero missing, zero unused, and zero duplicate anchors and zero duplicate URLs. Zero em-dashes, en-dashes, prose contractions, prose parentheticals, prose colons, or prose semicolons outside math. All LaTeX balanced. Categories `history business aerospace`. Debug tags on lines 13-14. Equation density in band at 70 and reference density at 233 anchors near the top of the 190-234 baseline, with primary references at 121 the highest in the series. The book and research categories at 50 and 43 are the lowest in the series and are the remaining expansion headroom, which a publication-review pass would address. Repaired 9 broken links inherited from the sibling corpus and consolidated 7 duplicate-URL anchors across the two density passes. Repaired 4 dead NASA URLs and dropped one NTRS accession number that could not be confirmed to be the document the title claimed. Forward references to A290 through A292 are plain prose rather than `post_url` links, per the back-reference-only convention. Cross-links to the SBIR series A132, A138, and A140 resolve.
