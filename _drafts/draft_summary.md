...
- `_drafts/apollo_guidance_computer.markdown` (A242, index 6) — Initial draft complete
...
**Status**: A237 published 2026-07-16 with four post-publication amendments. A238 draft complete through publication review, 212 lines, fourteen display equations, twenty-five references. A239 draft complete through publication review, 202 lines, ten display equations, twenty-five references. A240 draft complete through publication review, 188 lines, eight display equations, twenty-one references. A241 draft complete through publication review, 188 lines, twelve display equations, twenty references. A242 initial draft written 2026-07-17 covering the Apollo Guidance Computer with focus on the Instrumentation Laboratory at MIT under Draper (Polaris Poseidon Trident lineage, 1961 Apollo contract as NASA's first), the guidance problem (translunar coast, lunar orbit insertion, powered descent, ascent, rendezvous, transearth injection at total delta-V of 15-18 km/s), AGC hardware (Fairchild 4711 three-input NOR gates in RTL family, 4100 IC packages, 16-bit word, 11.7-microsecond instruction cycle at 85000 IPS, 2048 words erasable core plus 36864 words fixed core rope), core rope memory (Raytheon LOL hand-weaving, physical unmodifiability in flight), AGC software (350 programmers at peak, Hal Laning executive design, Colossus and Luminary at ~36000 and ~32000 AGC assembly lines, All-Digital Simulation at 20x real-time), real-time executive and priority scheduling (cooperative multitasking with 8 concurrent jobs in Block II, priority-based admission control), and the Apollo 11 1201/1202 alarms during descent (rendezvous radar overload, graceful degradation, Steve Bales decision matrix). Framework application section applies the six-axis framework to the Apollo Guidance Computer. 156 lines, three display equations (total mission delta-V budget, Tsiolkovsky rocket equation, AGC instruction rate). Fourteen references (two books Hall 1996 Journey to the Moon and Mindell 2008 Digital Apollo, three reference URLs for AGC source code repository and Draper Laboratory and Virtual AGC, five related posts to A237-A241, four primary research entries Battin 1982 space guidance, Hoag 1963 Apollo NGC systems, Hopkins Alonso Adcock 1965, Klumpp 1971 lunar descent guidance). Series index 6 of 12. Editorial date 2026-07-17 09:00 UTC. Awaiting equation-density review, reference-density review, and publication review passes.
