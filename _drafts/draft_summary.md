...
### Rocket Propellant Chemistry series (A217-A221) — Drafted

**Files**:
- `_drafts/rocket_propellant_chemistry_a_design_tradeoff_space.markdown` (A217)
- `_drafts/rocket_propellant_chemistry_solid_propellants.markdown` (A218)
- `_drafts/rocket_propellant_chemistry_cryogenic_liquid_propellants.markdown` (A219)
- `_drafts/rocket_propellant_chemistry_storable_and_hypergolic_liquid_propellants.markdown` (A220)
- `_drafts/rocket_propellant_chemistry_hybrid_propellants.markdown` (A221)
