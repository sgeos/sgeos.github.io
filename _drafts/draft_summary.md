...
**Files**:
- `_posts/2026-07-12-framing_and_the_co_development_mechanism.markdown` (A237, series opener) — Published
- `_drafts/pre_war_computing_origins_and_ballistics.markdown` (A238, index 2) — Draft complete through publication review, awaiting publish
- `_drafts/wartime_computing_and_code_breaking.markdown` (A239, index 3) — Draft complete through publication review, awaiting publish
- `_drafts/early_cold_war_air_defense_and_sage.markdown` (A240, index 4) — Draft complete through publication review, awaiting publish
- `_drafts/aerospace_simulation_and_real_time_systems.markdown` (A241, index 5) — Draft complete through publication review, awaiting publish
...
- `_drafts/silicon_valley_from_defense_contracting.markdown` (A246, index 10) — Draft complete through publication review, awaiting publish
- `_drafts/software_defined_aerospace_and_autonomy.markdown` (A247, index 11) — Draft complete through publication review, awaiting publish
- `_drafts/contemporary_snapshot_and_extrapolation.markdown` (A248, index 12, series closer) — Initial draft complete
...
**Article Numbers**: A237 through A248 (twelve articles planned; A237 published as of 2026-07-16, A238 initial draft as of 2026-07-16)
**Completion**: A237 complete and published (with post-publication equation-density, reference-density, and publication review amendments). A238 initial draft complete. A239-A248 pending.
**Publication Sensibility**: High (comprehensive rolling-publication treatment of the aerospace-computing co-development arc across editorial dates 2026-07-12 through 2026-07-23; back-reference-only within series to permit one-per-day rolling publication; each subsequent article can only cite earlier series articles)
**Status**: A237 published 2026-07-16 with four post-publication amendments. A238 draft complete through publication review, 212 lines, fourteen display equations, twenty-five references. A239 draft complete through publication review, 202 lines, ten display equations, twenty-five references. A240 draft complete through publication review, 188 lines, eight display equations, twenty-one references. A241 draft complete through publication review, 188 lines, twelve display equations, twenty references. A242 draft complete through publication review, 192 lines, nine display equations, twenty references. A243 draft complete through publication review, 178 lines, eight display equations, twenty-three references. A244 initial draft written 2026-07-17 covering Space Shuttle software as engineering landmark with focus on the Shuttle avionics architecture (four PASS computers plus one BFS running dissimilar software, IBM AP-101 general-purpose machines at 420000 IPS, one-megabit-per-second Multiplexer-Demultiplexer Data Bus), the Primary Avionics Software System (IBM Federal Systems Division at Owego NY, ~250 engineers at peak, ~22000 person-months to STS-1, Operational Program overlay approach), the Backup Flight System (Rockwell separate development, ~90000 lines HAL/S, STS-1 synchronization race condition, Knight-Leveson challenge to dissimilar-redundancy assumption), HAL/S programming language (Intermetrics 1972-1974, PL/I-based syntax with aerospace primitives and safety restrictions, compiler-enforced coding standards), the IBM FSD software process (Fagan inspection, defect density from 0.11 to 0.004 per KLOC, exponential decay with 3-5 year time constant, CMM antecedent), and reliability record (135 missions 1981-2011 with zero software-caused loss of vehicle or crew, Challenger and Columbia both non-software causes). Framework application section applies the six-axis framework to Shuttle software. 144 lines, four display equations (AP-101/AGC speed ratio, Lehman software size growth, defect density exponential decay, per-line development cost). Twelve references (one book Tomayko 1988 previously cited in A237, three reference URLs for HAL/S spec IBM FSD Wikipedia and NASA Shuttle avionics, four related posts to A237 A241 A242 A243, four primary research Fagan 1976, Fishman 1996 Fast Company, Madden and Rone 1984 previously cited in A237, Sperling and Weinstock 1985). Series index 8 of 12. Editorial date 2026-07-19 09:00 UTC (future-dated two days). Awaiting equation-density review, reference-density review, and publication review passes.
