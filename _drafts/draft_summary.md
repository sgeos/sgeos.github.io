...
- `_drafts/pre_war_computing_origins_and_ballistics.markdown` (A238, index 2) — Initial draft complete
...
**Status**: A237 published 2026-07-16, four post-publication amendments applied (second equation-density pass, second reference-density pass, publication review, and process file sync). 342 lines, eighteen display equations, fifty-seven references across four categories (twelve books, thirteen reference URLs, five related posts, twenty-seven primary research papers). Series slug `co_development_aerospace_computing`, series index 1 of 12, categories `history technology aerospace`. A238 initial draft written 2026-07-16 covering pre-war computing origins and ballistics with focus on the ballistic-table problem, mechanical fire-control computers (Ford Mark 1, Kerrison Predictor, Norden bombsight), analog differential analyzers (Bush, Aberdeen, Rockefeller), electromechanical predecessors (Bell Labs Stibitz, Zuse Z3, Harvard Mark I), and the origins of the ENIAC at the Moore School under BRL contract. Framework application section applies the six-axis framework to the pre-war era. 158 lines, five display equations (exterior ballistics point-mass equation, table operations count, analog error-scaling, ENIAC-DA-human speed ratio, ENIAC vacuum tube MTBF). Seventeen references (six books, four reference URLs, one related post to A237, six primary research papers). Series index 2 of 12. Editorial date 2026-07-13 09:00 UTC. Awaiting equation-density review, reference-density review, and publication review passes.
