...
- `_drafts/aerospace_simulation_and_real_time_systems.markdown` (A241, index 5) — Initial draft complete
...
**Status**: A237 published 2026-07-16 with four post-publication amendments. A238 draft complete through publication review, 212 lines, fourteen display equations, twenty-five references. A239 draft complete through publication review, 202 lines, ten display equations, twenty-five references. A240 draft complete through publication review, 188 lines, eight display equations, twenty-one references. A241 initial draft written 2026-07-17 covering aerospace simulation and real-time systems with focus on pre-digital flight simulation (Link Trainer 1930 patent, 10000 units delivered to USAAF in WWII), analog flight simulation (Reeves EAI, six-DOF equations of motion solved in real time), digital flight simulation (Link/Singer/CAE-Link, commercial airline adoption for pilot licensing credit, camera-model then CGI visual systems), hardware-in-the-loop testing (iron bird test rigs, end-to-end loop timing budget formalization), real-time operating systems (VxWorks 1987, VRTX 1980, pSOS 1982, RTEMS 1988, ARINC 653 partitioning standard, worst-case response time guarantees vs mean/quantile), and distributed interactive simulation (SIMNET DARPA 1983-1987, dead-reckoning bandwidth reduction, DIS IEEE 1278 1993, HLA IEEE 1516 2000, Live Virtual Constructive framework). Framework application section applies the six-axis framework to the simulation and real-time thread. 148 lines, six display equations (aircraft dynamics coupled equations for velocity and angular velocity, simulator update rate lower bound, hardware-in-the-loop timing budget, real-time worst-case response time definition, distributed simulation bandwidth with dead-reckoning). Thirteen references (one book Rolfe and Staples 1986, four reference URLs for ARINC 653 and Link Trainer and SISO and VxWorks, four related posts to A237 A238 A239 and A240, four primary research entries IEEE 1278 and IEEE 1516 standards, Link 1930 patent, Miller and Thorpe 1995 SIMNET paper). Series index 5 of 12. Editorial date 2026-07-16 09:00 UTC. Awaiting equation-density review, reference-density review, and publication review passes.
