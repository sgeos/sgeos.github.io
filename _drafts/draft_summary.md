...
- `_drafts/arpanet_and_networking_origins.markdown` (A243, index 7) — Initial draft complete
...
**Status**: A237 published 2026-07-16 with four post-publication amendments. A238 draft complete through publication review, 212 lines, fourteen display equations, twenty-five references. A239 draft complete through publication review, 202 lines, ten display equations, twenty-five references. A240 draft complete through publication review, 188 lines, eight display equations, twenty-one references. A241 draft complete through publication review, 188 lines, twelve display equations, twenty references. A242 draft complete through publication review, 192 lines, nine display equations, twenty references. A243 initial draft written 2026-07-17 covering ARPANET and networking origins with focus on the Advanced Research Projects Agency (1958 Sputnik response, IPTO under Licklider, funding pattern for CTSS Multics Berkeley Xerox PARC and ARPANET), packet switching (Baran 1964 RAND survivability motivation, Davies 1966 NPL efficiency motivation, packet-switching capacity gain over circuit switching for bursty traffic), ARPANET design and deployment (Roberts as IPTO director, Wesley Clark's IMP suggestion separating hosts from switches, BBN Honeywell DDP-516 IMP, first four nodes UCLA SRI UCSB Utah, 29 October 1969 "LO" first host-to-host message), growth and protocols (NCP 1970-1982, TCP by Cerf and Kahn 1974, TCP/IP split 1978, Metcalfe's Law N-squared scaling), aerospace research community role (MIT Instrumentation Laboratory, Stanford AI Lab, CMU CS, NASA Ames), and the 1975 transfer to Defense Communications Agency through 1983 MILNET split and 1990 ARPANET decommissioning transition to NSFNET and commercial internet. Framework application section applies the six-axis framework to ARPANET. 138 lines, two display equations (packet-switching capacity gain, Metcalfe's Law network value). Sixteen references (three books Abbate 1999 Hafner and Lyon 1996 Norberg and O'Neill 1996, two reference URLs for DARPA history and ISOC internet history, four related posts to A237 A240 A241 A242, seven primary research Baran 1964, Cerf and Kahn 1974, Davies 1966, Heart et al 1970 IMP, Licklider 1960, Licklider and Taylor 1968, Metcalfe and Boggs 1976). Series index 7 of 12. Editorial date 2026-07-18 09:00 UTC (future-dated one day). Awaiting equation-density review, reference-density review, and publication review passes.
