...
### History of SpaceX series opener (A281) — Drafted

**Files**:
- `_drafts/spacex_history_framing.markdown` (A281, series opener of planned twelve-article History of SpaceX series, series `spacex_history`, series_index 1 of 12)
...
**Completion**: 100% ready for standalone publication
