...
The specific extrapolation strategy that the preceding section applies is one among several plausible alternatives. Alternative strategies emphasize specific different structural drivers that would produce specific different trajectories under the extrapolation window.
