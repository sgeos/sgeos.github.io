...
That is a trade an aircraft company can see and a rocket company might not, because it is a trade about what the structure is allowed to fail at rather than about how strong it is. **The Atlas is not a stronger tank. It is a tank that has been permitted to have a failure mode nobody would tolerate in an aeroplane**, in exchange for a mass fraction nobody could reach any other way, and permitting that failure mode is a programme decision rather than an engineering one.
