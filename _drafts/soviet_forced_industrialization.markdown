...
for aggregate Russian output, comparable in magnitude to the wartime destruction ratio the [Meiji Japan case treated in the fifth article of the series][related_post_meiji_japan] exhibited across the 1941-1946 window. The specifically Soviet case is unusual because the collapse occurred without any military destruction of the industrial base, and represented an institutional-transition cost rather than a physical-destruction cost. The comparable magnitude across the two mechanisms is instructive for the framework's overall treatment of catch-up mechanisms that produce structural failure modes.
